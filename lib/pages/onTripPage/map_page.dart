                                                              ...
                                                              decoration: BoxDecoration(
                                                                  ...
                                                                  border: Border.all(
                                                                      ...
                                                                      width: (_bottom == 0)
                                                                          ? 0
                                                                          : 1.5),
                                                                  color: (_pickaddress == true && _bottom == 1)
                                                                      ? const Color.fromARGB(
                                                                          255,
                                                                          255,
                                                                          232,
                                                            ...
                                                            InkWell(
                                                              ...
                                                              child: Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                      boxShadow: [
                                                                        BoxShadow(
                                                                            blurRadius: (_bottom == 1)
                                                                                ? 8
                                                                                : 8,
                                                                            color: (_bottom == 1)
                                                                                ? Colors.pink.withOpacity(0.1)
                                                                                : Colors.pink.withOpacity(0.1),
                                                                            spreadRadius: (_bottom == 1) ? 2 : 2)
                                                                      ],
                                                                      borderRadius:
                                                                          BorderRadius.circular(media.width *
                                                                              0.02),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      (_dropaddress == true &&
                                                                          ...
                                                                          ? Expanded(
                                                                              child: TextField(
                                                                                  autofocus: true,
                                                                                  decoration: InputDecoration(contentPadding: (languageDirection == 'rtl') ? EdgeInsets.only(bottom: media.width * 0.035) : EdgeInsets.only(bottom: media.width * 0.047), border: InputBorder.none, hintText: languages[choosenLanguage]['text_4lettersforautofill'], hintStyle: GoogleFonts.roboto(fontSize: media.width * 14, color: const Color.fromARGB(255, 109, 109, 117))),
                                                                                  maxLines: 1,
                                                                                  onChanged: (val) {
                                                                                    if (val.length >= 4) {
                                                                                      getAutoAddress(val, _sessionToken, center.latitude, center.longitude);
                                                                          ...
                                                                          : Expanded(
                                                                              child: Text(
                                                                              "Where are you going?",
                                                                              style: GoogleFonts.roboto(fontSize: media.width * twelve, color: Colors.blueGrey),
                                                                            )),
                                                                    ],
                                                                  )),
                                                            ),
