...
Color page = const Color(0xffEDF3FF);
Color buttonColor = const Color(0xFFFF605C);
...
Color loaderColor = const Color(0xFFFF605C);
Color notUploadedColor = Colors.red;
Color verifyPendingBck = const Color(0xffFEF2F2);
Color verifyPending = const Color.fromARGB(255, 255, 77, 74);
